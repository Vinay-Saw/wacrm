...
export function ContactsClient({ initialTags = [] }: ContactsClientProps) {
  ...
  // All tags for display (seeded from initialTags)
                      ...
                      <div className="flex flex-col">
                        <span className="text-foreground flex items-center gap-1.5 font-medium">
                          ...
                          {contact.is_primary_company_contact && (
                            <span className="bg-primary/15 text-primary inline-flex items-center rounded px-1.5 py-0.5 text-[10px] font-semibold">
                              Primary
                            </span>
                          )}
                        </span>
