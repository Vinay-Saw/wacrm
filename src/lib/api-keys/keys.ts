...
//
// Why the `automacrm_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     an Automa CRM key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for an `automacrm_test_` variant if
...
export const API_KEY_PREFIX = 'automacrm_live_';
