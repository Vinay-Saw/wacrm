...
//
// Every delivery carries an `X-Automa-Crm-Signature` header so receivers
// can verify the request really came from Automa CRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Automa-Crm-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Automa-Crm-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so an Automa CRM-to-Automa CRM integration
