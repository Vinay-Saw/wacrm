...
//
// Registered only when BOTH AUTOMA_CRM_ENABLE_WRITES and
// AUTOMA_CRM_ENABLE_BROADCASTS are set. A single call can message up to
...
export function registerBroadcastTools(server: McpServer, client: AutomaCrmClient): void {
  server.registerTool(
    'send_broadcast',
    {
